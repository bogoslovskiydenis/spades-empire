<template>
  <div class="bonuses-page">
    <section class="bonuses-page-section">
      <!-- Banner Container -->
...
const bannerImage = computed(() => pageData.value?.body?.banner_img?.fullSettings?.[0] || BonusPageBanner)
...
.banner-container {
  ...
  background-image: url('~/assets/images/BonusPageBaner.png');
